...
headersHandover= {'x-app':'smart-pos','x-version':'10','x-deviceId':'k-201','x-sign':'08216bc91cb64412848317903070f9e3','x-sessionId':sessionId}
handoverData = {'startTime':'2015-05-10 17:34:58','endTime':'2015-05-16 17:34:58'}
resp_handover = requests.post(handover_url,data=handoverData,headers=headersHandover)


print(resp_data)
print respData
print sessionId
print(headersHandover)
print(resp_handover)
print(resp_handover.text)
